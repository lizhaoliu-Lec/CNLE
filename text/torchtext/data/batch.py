...
class Batch(object):
    ...
    def __init__(self, data=None, dataset=None, device=None, train=True):
        ...
        if data is not None:
            ...
            limited_idx_to_full_idx = deepcopy(
                field.decoder_to_vocab)  # should avoid this with a conditional in map to full
            oov_to_limited_idx = {}
                ...
                if field is not None:
                    ...
                    if not field.include_lengths:
                        ...
                        entry, lengths, limited_entry, raw = field.process(batch, device=device, train=train,
                                                                           limited=field.decoder_stoi,
                                                                           l2f=limited_idx_to_full_idx,
                                                                           oov2l=oov_to_limited_idx)
