...
def write_logical_forms(greedy, args):
    ...
    table_path = os.path.join(data_dir, 'dev.tables.jsonl') if 'valid' in args.evaluate else os.path.join(data_dir,
                                                                                                          'test.tables.jsonl')
...
if __name__ == '__main__':
    ...
    parser.add_argument('ids',
                        help='path to file for indices, a list of integers indicating the index into the dev/test set of the predictions on the corresponding line in \'predicitons\'')
