...
from .common import positional_encodings_like, INF, EPSILON, TransformerEncoder, TransformerDecoder, PackedLSTM, \
    ...
    DualTransformerEncoder, FreeEmbedding


class DualTransNoSelfNetV9(nn.Module):
    ...
    def __init__(self, field, args):
        ...
        self.encoder_embeddings = FreeEmbedding(field, args.dimension,
                                                dropout=args.dropout_ratio, project=False,
                                                requires_grad=False)

        # TODO why not use shared embedding
        self.decoder_embeddings = FreeEmbedding(field, args.dimension,
                                                dropout=args.dropout_ratio, project=False,
                                                requires_grad=True)
