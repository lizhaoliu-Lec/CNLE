...
class InteractionNetworkV1(nn.Module):
    ...
    def forward(self, batch):
        ...
        coattended_context, coattended_question = self.coattention(context_embedded, question_embedded, context_padding,
                                                                   question_padding)[-1]

        self_attended_context = self.self_attentive_encoder_context(coattended_context, padding=context_padding)
        ...
        self_attended_question = self.self_attentive_encoder_question(coattended_question, padding=question_padding)
