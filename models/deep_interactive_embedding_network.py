...
class DeepInteractiveEmbeddingNetwork(nn.Module):
    ...
    def forward(self, batch):
        ...
        context_encoded, (enc_h_context, enc_c_context) = self.bilstm_before_coattention(context_embedded,
                                                                                         context_lengths)
        # question_encoded: (b, seq_len_q, hidden)
        # question_encoded = self.bilstm_before_coattention(question_embedded, question_lengths)[0]
        question_encoded, (enc_h_question, enc_c_question) = self.bilstm_before_coattention(question_embedded,
                                                                                            question_lengths)
