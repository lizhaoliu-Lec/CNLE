...
class InteractionNetworkV2(nn.Module):
    ...
    def __init__(self, field, args):
        ...
        self.coattention = CoattentiveTransformerEncoder(args.dimension, args.transformer_heads,
    ...
    def forward(self, batch):
        ...
        context_question_pairs = self.coattention(context_embedded, question_embedded, context_padding,
                                                  question_padding)
        coattended_context = [i[0] for i in context_question_pairs]
        coattended_question = [i[1] for i in context_question_pairs]
        ...
        if self.training:
            ...
            self_attended_decoded = self.self_attentive_decoder(answer_embedded[:, :-1].contiguous(),
                                                                coattended_context, context_padding=context_padding,
            ...
            return None, self.greedy(coattended_context, final_context, final_question,
                                     context_indices, question_indices,
