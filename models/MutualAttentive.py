...
from .common import positional_encodings_like, INF, EPSILON, TransformerEncoder, TransformerDecoder, PackedLSTM, \
    ...
    DualTransformerEncoderLayer


class MutualAttentive(nn.Module):
    ...
    def __init__(self, field, args):
        ...
        self.coattention = DualTransformerEncoderLayer(args.dimension, args.transformer_heads,
                                                         args.transformer_hidden,
                                                         args.dropout_ratio)
        # dim = 2 * args.dimension + args.dimension + args.dimension
        dim = 3 * args.dimension
    ...
    def forward(self, batch):
        ...
        coattended_context = coattended_context
        coattended_question = coattended_question
        # print('coattended_context', coattended_context.size())
        # print('coattended_question', coattended_question.size())
